...
j1.adapter['themer'] = (function (j1, window) {
  ...
  return {
    ...
    init: function () {
      ...
      var dependencies_met_navigator_started = setInterval (function () {
        // if (j1.adapter.navigator.getState() == 'started') {
