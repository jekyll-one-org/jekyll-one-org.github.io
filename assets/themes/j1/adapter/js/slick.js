    ...
    init: function (options) {
      ...
      var dependencies_met_page_ready = setInterval (function (options) {
        ...
        if (j1.getState() === 'finished' && pageVisible && atticFinished) {
          logger.info('\n' + 'carousel is being initialized on id: ' + 'collection_carousel_portfolio');
          ...
          load_dependencies['dependencies_met_html_loaded_collection_carousel_portfolio'] = setInterval (function (options) {
          ...
          logger.info('\n' + 'carousel is being initialized on id: ' + 'collection_carousel_biography');
          ...
          load_dependencies[dependency] = '';
          // initialize carousel if HTML portion successfully loaded
          load_dependencies['dependencies_met_html_loaded_collection_carousel_biography'] = setInterval (function (options) {
            // check if HTML portion of the carousel is loaded successfully (loadcarouselHTML)
          ...
          logger.info('\n' + 'carousel is being initialized on id: ' + 'collection_carousel_fantasy');
          ...
          load_dependencies[dependency] = '';
          // initialize carousel if HTML portion successfully loaded
          load_dependencies['dependencies_met_html_loaded_collection_carousel_fantasy'] = setInterval (function (options) {
            // check if HTML portion of the carousel is loaded successfully (loadcarouselHTML)
          ...
          logger.info('\n' + 'carousel is being initialized on id: ' + 'collection_carousel_romance');
          ...
          load_dependencies[dependency] = '';
          // initialize carousel if HTML portion successfully loaded
          load_dependencies['dependencies_met_html_loaded_collection_carousel_romance'] = setInterval (function (options) {
            // check if HTML portion of the carousel is loaded successfully (loadcarouselHTML)
          ...
          logger.info('\n' + 'carousel is being initialized on id: ' + 'post_carousel_life');
          logger.info('\n' + 'collect responsive settings for carousel on id: ' + 'post_carousel_life');
          // collect breakpoint settings from carousel config
          responsiveSettings = $.extend({}, [{"breakpoint":null, "settings":{"breakOn":1024, "slidesToShow":2, "slidesToScroll":2}}, {"breakpoint":null, "settings":{"breakOn":600, "slidesToShow":1, "slidesToScroll":1, "dots":true}}, {"breakpoint":null, "settings":{"breakOn":480, "slidesToShow":1, "slidesToScroll":1}}]);
          // generate carousel breakpoint settings as YAML data structure
          carouselResponsiveSettings  = '[' ;
          ...
          carouselResponsiveSettings += ']';
          // create dynamic loader variable|s
          dependency = 'dependencies_met_html_loaded_post_carousel_life';
          load_dependencies[dependency] = '';
          // initialize carousel if HTML portion successfully loaded
          load_dependencies['dependencies_met_html_loaded_post_carousel_life'] = setInterval (function (options) {
            // check if HTML portion of the carousel is loaded successfully (loadcarouselHTML)
            xhrLoadState = j1.xhrDOMState['#post_carousel_life_parent'];
            if ( xhrLoadState === 'success' ) {
              // collect general carousel settings
              carouselOptions  = $.extend({}, {"autoplay":false, "arrows":true, "dots":true, "slidesToShow":3, "slidesToScroll":1, "responsive":true});
              carouselSettings = $.extend(true, {}, slickDefaults, carouselOptions );
              // convert carousel responsive settings to object (carouselResponsiveSettingsOBJ)
              carouselResponsiveSettingsYAML    = yaml.loadAll(carouselResponsiveSettings, 'utf8');
              carouselResponsiveSettingsOBJ     = carouselResponsiveSettingsYAML[0];
              carouselResponsiveSettingsSTRING  = JSON.stringify(carouselResponsiveSettingsOBJ, null, 4);
              logger.debug('\n' + 'responsive settings on carousel id #post_carousel_life: ' + '\n' + carouselResponsiveSettingsSTRING);
              $('.post-carousel-life').on('init', function(event, slick) {
                logger.info('\n' + 'carousel initialized on id: post_carousel_life');
                slick_lightbox_enabled = '';
                // check if a lightbox is used|enabled
                if ( slick_lightbox_enabled !== '' && slick_lightbox_enabled == 'true' ) {
                  slick_lightbox_enabled = true;
                ...
                if (slick_lightbox_enabled) {
                  logger.info('\n' + 'initialize lightbox on id: post_carousel_life');
                  // See: http://mreq.github.io/slick-lightbox/demo/
                  $('#post_carousel_life').slickLightbox({
                    caption:                  slickLightboxOptions.caption,
                    useHistoryApi:            slickLightboxOptions.useHistoryApi,
                    background:               slickLightboxOptions.background,
                    closeOnEscape:            slickLightboxOptions.closeOnEscape,
                ...
                logger.info('\n' + 'adjust positions of arrows on id: post_carousel_life');
                var buttons = $("#post_carousel_life > button");
                // recalculate right arrow position based on gutter settings
                //
                var percentage_right = 3 + carouselSettings.gutters;
                $.each($(buttons), function(index, button) {
                ...
                // add CSS style for individual top position for all carousels
                //
                if ($('#post_carousel_life_caption')) {
                  logger.info('\n' + 'adjust top position of arrows on id: post_carousel_life');
                  var buttons = $("#post_carousel_life > button");
                  $.each($(buttons), function(index, button) {
                    $(button).addClass('slick-arrow-post_carousel_life');
                  });
                }
              }); // END on carousel init
              function debounce(callback, timeout = 300) {
              ...
              function positionSlickArrows (e) {
                var dependencies_met_page_ready = setInterval (function (options) {
                  ...
                  if ( j1.getState() === 'finished' && pageVisible ) {
                    ...
                    const $slick = $('.post-carousel-life');
                    const $slides = $slick.find('.slick-slide');
                    const $currentSlide = $slides.filter((index, slide) => $(slide).hasClass('slick-current'));
                    if (carousel_type == 'example') {
                      slideImageHeight = ($currentSlide.find('').height() / 2) - 25;
                    ...
                    logger.info('\n' + 'adjust top arrow position (centered) by ' + slideImageHeight + ' on id: post_carousel_life');
                    $('.slick-arrow-post_carousel_life').css('top', slideImageHeight + 'px');
                    clearInterval(dependencies_met_page_ready);
                  }
                }, 25);
              }
              // set individual arrow positions for a carousel
              //
              $('.post-carousel-life').on('init afterChange', positionSlickArrows);
              // setup the carousel
              logger.info('\n' + 'carousel is being setup on id: ' + 'post_carousel_life');
              $('.post-carousel-life').slick({
                accessibility:              carouselSettings.accessibility,
                adaptiveHeight:             carouselSettings.adaptiveHeight,
                arrows:                     carouselSettings.arrows,
                autoplay:                   carouselSettings.autoplay,
              ...
              // NOT issued correctly (disabled for now)
              // $(window).resize(debounce(positionSlickArrows, 100));
              clearInterval(load_dependencies['dependencies_met_html_loaded_post_carousel_life']);
            }
          }, 25); // END
          logger.info('\n' + 'carousel is being initialized on id: ' + 'post_carousel_life_sepia');
          logger.info('\n' + 'collect responsive settings for carousel on id: ' + 'post_carousel_life_sepia');
          // collect breakpoint settings from carousel config
          responsiveSettings = $.extend({}, [{"breakpoint":null, "settings":{"breakOn":1024, "slidesToShow":2, "slidesToScroll":2}}, {"breakpoint":null, "settings":{"breakOn":600, "slidesToShow":1, "slidesToScroll":1, "dots":true}}, {"breakpoint":null, "settings":{"breakOn":480, "slidesToShow":1, "slidesToScroll":1}}]);
          // generate carousel breakpoint settings as YAML data structure
          carouselResponsiveSettings  = '[' ;
          ...
          carouselResponsiveSettings += ']';
          // create dynamic loader variable|s
          dependency = 'dependencies_met_html_loaded_post_carousel_life_sepia';
          load_dependencies[dependency] = '';
          // initialize carousel if HTML portion successfully loaded
          load_dependencies['dependencies_met_html_loaded_post_carousel_life_sepia'] = setInterval (function (options) {
            // check if HTML portion of the carousel is loaded successfully (loadcarouselHTML)
            xhrLoadState = j1.xhrDOMState['#post_carousel_life_sepia_parent'];
            if ( xhrLoadState === 'success' ) {
              // collect general carousel settings
              carouselOptions  = $.extend({}, {"autoplay":false, "arrows":true, "dots":true, "slidesToShow":3, "slidesToScroll":1, "responsive":true});
              carouselSettings = $.extend(true, {}, slickDefaults, carouselOptions );
              ...
              carouselResponsiveSettingsOBJ     = carouselResponsiveSettingsYAML[0];
              carouselResponsiveSettingsSTRING  = JSON.stringify(carouselResponsiveSettingsOBJ, null, 4);
              logger.debug('\n' + 'responsive settings on carousel id #post_carousel_life_sepia: ' + '\n' + carouselResponsiveSettingsSTRING);
              $('.post-carousel-life-sepia').on('init', function(event, slick) {
                logger.info('\n' + 'carousel initialized on id: post_carousel_life_sepia');
                slick_lightbox_enabled = '';
                // check if a lightbox is used|enabled
                if ( slick_lightbox_enabled !== '' && slick_lightbox_enabled == 'true' ) {
                  slick_lightbox_enabled = true;
                ...
                if (slick_lightbox_enabled) {
                  logger.info('\n' + 'initialize lightbox on id: post_carousel_life_sepia');
                  // See: http://mreq.github.io/slick-lightbox/demo/
                  $('#post_carousel_life_sepia').slickLightbox({
                    caption:                  slickLightboxOptions.caption,
                    useHistoryApi:            slickLightboxOptions.useHistoryApi,
                    background:               slickLightboxOptions.background,
                    closeOnEscape:            slickLightboxOptions.closeOnEscape,
                ...
                logger.info('\n' + 'adjust positions of arrows on id: post_carousel_life_sepia');
                var buttons = $("#post_carousel_life_sepia > button");
                // recalculate right arrow position based on gutter settings
                //
                var percentage_right = 3 + carouselSettings.gutters;
                $.each($(buttons), function(index, button) {
                ...
                // add CSS style for individual top position for all carousels
                //
                if ($('#post_carousel_life_sepia_caption')) {
                  logger.info('\n' + 'adjust top position of arrows on id: post_carousel_life_sepia');
                  var buttons = $("#post_carousel_life_sepia > button");
                  $.each($(buttons), function(index, button) {
                    $(button).addClass('slick-arrow-post_carousel_life_sepia');
                  });
                }
              }); // END on carousel init
              function debounce(callback, timeout = 300) {
              ...
              function positionSlickArrows (e) {
                var dependencies_met_page_ready = setInterval (function (options) {
                  ...
                  if ( j1.getState() === 'finished' && pageVisible ) {
                    const carousel_type = 'post';
                    const $slick = $('.post-carousel-life-sepia');
                    const $slides = $slick.find('.slick-slide');
                    const $currentSlide = $slides.filter((index, slide) => $(slide).hasClass('slick-current'));
                    if (carousel_type == 'example') {
                      slideImageHeight = ($currentSlide.find('').height() / 2) - 25;
                    ...
                    logger.info('\n' + 'adjust top arrow position (centered) by ' + slideImageHeight + ' on id: post_carousel_life_sepia');
                    $('.slick-arrow-post_carousel_life_sepia').css('top', slideImageHeight + 'px');
                    clearInterval(dependencies_met_page_ready);
                  }
                }, 25);
              }
              // set individual arrow positions for a carousel
              //
              $('.post-carousel-life-sepia').on('init afterChange', positionSlickArrows);
              // setup the carousel
              logger.info('\n' + 'carousel is being setup on id: ' + 'post_carousel_life_sepia');
              $('.post-carousel-life-sepia').slick({
                accessibility:              carouselSettings.accessibility,
                adaptiveHeight:             carouselSettings.adaptiveHeight,
                arrows:                     carouselSettings.arrows,
                autoplay:                   carouselSettings.autoplay,
              ...
              // NOT issued correctly (disabled for now)
              // $(window).resize(debounce(positionSlickArrows, 100));
              clearInterval(load_dependencies['dependencies_met_html_loaded_post_carousel_life_sepia']);
            }
          }, 25); // END
          logger.info('\n' + 'carousel is being initialized on id: ' + 'example_carousel_arrows_dots');
          ...
          load_dependencies[dependency] = '';
          // initialize carousel if HTML portion successfully loaded
          load_dependencies['dependencies_met_html_loaded_example_carousel_arrows_dots'] = setInterval (function (options) {
            // check if HTML portion of the carousel is loaded successfully (loadcarouselHTML)
          ...
          logger.info('\n' + 'carousel is being initialized on id: ' + 'image_carousel_simple');
          ...
          load_dependencies[dependency] = '';
          // initialize carousel if HTML portion successfully loaded
          load_dependencies['dependencies_met_html_loaded_image_carousel_simple'] = setInterval (function (options) {
            // check if HTML portion of the carousel is loaded successfully (loadcarouselHTML)
          ...
          logger.info('\n' + 'carousel is being initialized on id: ' + 'image_carousel_full');
          ...
          load_dependencies[dependency] = '';
          // initialize carousel if HTML portion successfully loaded
          load_dependencies['dependencies_met_html_loaded_image_carousel_full'] = setInterval (function (options) {
            // check if HTML portion of the carousel is loaded successfully (loadcarouselHTML)
