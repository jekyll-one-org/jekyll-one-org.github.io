    ...
    init: function (options) {
      ...
      var dependencies_met_page_ready = setInterval (function (options) {
        ...
        if (j1.getState() === 'finished' && contentVisible) {
          logger.info('\n' + 'carousel is being initialized on id: ' + 'post_carousel_featured');
          ...
          load_dependencies['dependencies_met_html_loaded_post_carousel_featured'] = setInterval (function (options) {
