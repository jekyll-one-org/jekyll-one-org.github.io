 ...
 # -----------------------------------------------------------------------------
*/
'use strict';j1.adapter.waves=function(e,t){var n,i,a,d,o,s,r,l,u,f,m=e.getCookieNames(),g=e.readCookie(m.user_state);$(t).width();return{init:function(t){$.extend({module_name:'j1.adapter.waves',generated:'2023-06-08 22:06:55 +0200'},t);d=null!=t?$.extend({},t):{},n=$.extend({},{enabled:!1,themes:["UnoLight"]}),i=$.extend({},{enabled:!1,themes:["UnoLight"]}),a=$.extend(!0,{},n,i,d),l=e.adapter.waves,r=g.theme_name,u=log4javascript.getLogger('j1.adapter.wave');var f=setInterval(function(){var t='block'==$('#no_flicker').css("display"),n='finished'==e.adapter.attic.getState();'finished'===e.getState()&&t&&n&&(o=a.themes.toString(),s=a.themes.indexOf(r)>-1,l.setState('started'),u.debug("\nstate: "+l.getState()),u.info("\nmodule is being initialized"),u.debug("\nthemes allowd: "+o),u.debug("\ntheme detected: "+r),'all'===o?(u.info("\nactivate waves for theme: all"),setTimeout(function(){$('.wave').show(),u.info("\ninitializing module finished")},1e3)):s?(u.info("\nactivate waves for theme: "+r),setTimeout(function(){$('.wave').show(),u.info("\ninitializing module finished")},1e3)):(u.warn("\nno valid theme/s found"),u.warn("\ndeactivate (hide) waves"),setTimeout(function(){$('.wave').hide(),u.info("\ninitializing module finished")},1e3)),clearInterval(f))},25)},messageHandler:function(e,t){var n=JSON.stringify(t,undefined,2);return f="\nreceived message from "+e+': '+n,u.debug(f),'command'===t.type&&'module_initialized'===t.action&&u.info('\n'+t.text),!0},setState:function(e){l.state=e},getState:function(){return l.state}}}(j1,window);
