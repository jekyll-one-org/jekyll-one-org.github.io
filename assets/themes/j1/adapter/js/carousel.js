  ...
  return {
    ...
    init: function (options) {
      ...
      var settings = $.extend({
        ...
        generated:   '2019-09-27 08:51:27 +0200'
      }, options);
      ...
      logger.info('module is being initialized');
          ...
          if ($('#owl_demo_text_carousel').length) {
            ...
            function customDataSuccess_1(data){
              ...
              logText = 'Slider on ID owl_demo_text_carousel initializing finished';
              logger.info(logText);
          ...
          if ($('#owl_demo_text_carousel_parallax').length) {
            ...
            function customDataSuccess_2(data){
              ...
              logText = 'Slider on ID owl_demo_text_carousel_parallax initializing finished';
              logger.info(logText);
          ...
          if ($('#owl_demo_cats').length) {
            ...
            function customDataSuccess_3(data){
              ...
              logText = 'Slider on ID owl_demo_cats initializing finished';
              logger.info(logText);
          ...
          if ($('#owl_demo_simple').length) {
            ...
            function customDataSuccess_4(data){
              ...
              logText = 'Slider on ID owl_demo_simple initializing finished';
              logger.info(logText);
          ...
          if ($('#owl_demo_oneslide').length) {
            ...
            function customDataSuccess_5(data){
              ...
              logText = 'Slider on ID owl_demo_oneslide initializing finished';
              logger.info(logText);
