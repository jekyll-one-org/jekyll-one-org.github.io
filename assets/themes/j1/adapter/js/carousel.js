 ...
 # -----------------------------------------------------------------------------
 #  Adapter generated: 2021-07-16 07:18:35 +0000
 # -----------------------------------------------------------------------------
*/
// -----------------------------------------------------------------------------
// ESLint shimming
      ...
      var dependencies_met_page_finished = setInterval(function() {
        if (j1.getState() == 'finished') {
              ...
              if ($('#demo_text_carousel').length) {
                  logText = 'slider is being initialized on id: #demo_text_carousel';
                  logger.info(logText);
                ...
                function customDataSuccess_1(data){
                  ...
                  logText = 'initializing slider finished on id: demo_text_carousel';
                  logger.info(logText);
              ...
              if ($('#demo_text_carousel_parallax').length) {
                  logText = 'slider is being initialized on id: #demo_text_carousel_parallax';
                  logger.info(logText);
                  _this.setState('running');
                  logger.info('state: ' + _this.getState());
                  logger.info('module is being initialized');
                ...
                function customDataSuccess_2(data){
                  ...
                  logText = 'initializing slider finished on id: demo_text_carousel_parallax';
                  logger.info(logText);
                } // END customDataSuccess_2
              } // END if carousel exists
              // Create an Carousel INSTANCE if slider on id: demo_cats exists
              if ($('#demo_cats').length) {
                  logText = 'slider is being initialized on id: #demo_cats';
                  logger.info(logText);
                  _this.setState('running');
                  logger.info('state: ' + _this.getState());
                  logger.info('module is being initialized');
              ...
              if ($('#demo_oneslide').length) {
                ...
                function customDataSuccess_5(data){
                  ...
                  logText = 'initializing slider finished on id: demo_oneslide';
                  logger.info(logText);
