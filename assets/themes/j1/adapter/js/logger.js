...
j1.adapter['logger'] = (function (j1, window) {
  ...
  return {
    ...
    init: function (options) {
      ...
      /* eslint-disable */
      loggerOptions       = $.extend({}, {"appenders":[{"name":"Console Appender", "appender":{"name":"consoleAppender", "enabled":true}}, {"name":"Ajax Appender", "appender":{"name":"ajaxAppender", "enabled":true}}, {"name":"Popup Appender", "appender":{"name":"popupAppender", "enabled":false}}], "loggers":[{"name":"Parent Logger", "logger":{"type":"parent", "name":"j1", "appender":["consoleAppender", "ajaxAppender"], "level":{"production":"warn", "development":"debug"}}}], "tz_offset":"GMT+01:00"});
      utilServerOptions   = $.extend({}, {"enabled":true, "private_data":"_data/private.yml", "ssl":false, "origin":"localhost", "host_name":"0.0.0.0", "port":40020, "verbose":false, "logger_client":{"log_folder":"log", "log_file_name":"messages", "log_file_ext":"log", "create_on_start":true, "reset_on_start":true, "rolling_files":false, "file_mode":"append"}, "oauth_client":{"enabled":false, "provider":"github", "provider_url":"https://github.com", "token_path":"/login/oauth/access_token", "authorize_path":"/login/oauth/authorize"}, "git_client":{"enabled":false, "secret":"12ada70c0d34914d194f1a790c9b23bd", "payload_url":"https://smee.io/bzTe8lpQq1KeSJF", "pull":{"execute":false, "response_success":"The pull request to your local working copy finished successfully.", "response_failed":"The pull request to your local working copy has failed. Reason: "}}, "npm_client":{"enabled":false, "built":{"execute":false, "response_success":"The built request to your local site finished successfully.", "response_failed":"The built request to your local fite has failed. Reason: "}}, "commit_detection":{"modal_commit_detected":{"enabled":true, "autohide":false, "autohidden":5000}, "modal_pull_response":{"enabled":true, "autohide":false, "autohidden":5000}}});
      /* eslint-enable */
