  ...
  return {
    ...
    init: function (options) {
      ...
      var settings = $.extend({
        ...
        generated:   '2021-04-26 00:10:13 +0000'
      }, options);
      // -----------------------------------------------------------------------
      // rouge initializer
      // -----------------------------------------------------------------------
