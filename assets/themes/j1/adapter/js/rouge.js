  ...
  return {
    ...
    init: function (options) {
      ...
      var settings = $.extend({
        ...
        generated:   '2021-07-11 16:21:27 +0000'
      }, options);
      // -----------------------------------------------------------------------
      // rouge initializer
      // -----------------------------------------------------------------------
