...
j1.adapter['navigator'] = (function (j1, window) {
  ...
  var session_state               = {};
  var themerEnabled               = false;                 //was (test): false;
  ...
  return {
    ...
    init: function (options) {
      ...
      var settings  = $.extend({
        ...
        generated:   '2021-02-17 19:26:13 +0000'
      }, options);
      // -----------------------------------------------------------------------
      // options loader
      // -----------------------------------------------------------------------
