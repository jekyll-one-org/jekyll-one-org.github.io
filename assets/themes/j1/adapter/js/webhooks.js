...
j1.adapter['webhooks'] = (function (j1, window) {
  ...
  return {
    ...
    init: function () {
      ...
      moduleOptions = $.extend({}, {"enabled":true, "xhr_container_id":"web_hook_modals", "xhr_data_path":"/assets/data/webhook/index.html", "mode":"silent", "commit_detection":{"modal_commit_detected":{"enabled":true, "autohide":false, "autohidden":5000}, "modal_pull_response":{"enabled":true, "autohide":false, "autohidden":5000}}, "git_client":{"pull":{"execute":true, "response_success":"The pull request to your local working copy finished successfully.", "response_failed":"The pull request to your local working copy has failed. Reason: "}}, "npm_client":{"built":{"execute":false, "response_success":"The built request to your local site finished successfully.", "response_failed":"The built request to your local fite has failed. Reason: "}}, "secret":"12ada70c0d34914d194f1a790c9b23bd", "payload_url":"https://smee.io/bzTe8lpQq1KeSJF", "private_data":"_data/private.yml", "ssl":false, "origin":"localhost", "host_name":"0.0.0.0", "port":44444, "verbose":false, "utility_server":{"enabled":true, "ssl":false, "origin":"localhost", "host_name":"0.0.0.0", "port":44444, "verbose":false, "oauth_client":{"enabled":true, "provider":"github", "provider_url":"https://github.com", "token_path":"/login/oauth/access_token", "authorize_path":"/login/oauth/authorize"}, "git_client":{"enabled":true, "secret":"12ada70c0d34914d194f1a790c9b23bd", "payload_url":"https://smee.io/bzTe8lpQq1KeSJF", "pull":{"execute":true, "response_success":"The pull request to your local working copy finished successfully.", "response_failed":"The pull request to your local working copy has failed. Reason: "}}, "npm_client":{"enabled":true, "built":{"execute":false, "response_success":"The built request to your local site finished successfully.", "response_failed":"The built request to your local fite has failed. Reason: "}}, "logger_client":{"enabled":false, "payload_url_app":"https://preview.jekyll.one/", "payload_url_web":"http://localhost:16001/log2disk?request=write", "log_folder":"log", "log_file_name":"messages", "log_file_ext":"log", "create_on_start":true, "reset_on_start":true, "rolling_files":false, "file_mode":"append"}}, "comment":{"name":"j1-template@jekyll-one-org", "user":"j1juergen", "repo":"jekyll-one-org/j1-template", "server_url":"https://github.com/jekyll-one-org/j1-template/settings/hooks"}});
